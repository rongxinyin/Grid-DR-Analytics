...
class ReturnAirDuctLeakages < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  def description
    return "The return duct of an air system typically operates at negative pressure, thus the leakage in the return duct (outside of conditioned space) results in increased heating and cooling load due to unconditioned air being drawn into the return duct and mixing with return air from conditioned spaces. This measure simulates the return air leakage by modifying the Controller:OutdoorAir object in EnergyPlus. This measure was authored by Herrick Laboratory researchers at Purdue University in collaboration with staff from the National Renewable Energy Laboratory. For assistance using this measure please post to https://unmethours.com/questions/"
  end
