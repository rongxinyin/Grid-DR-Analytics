...
def create_output_variable_measure(params):
    output = dict()
    output.update({'measure_dir_name': 'AddOutputVariable'})
    output['arguments']={}
    output['arguments']['variable_name'] = params.get('variable_name')
    output['arguments']['reporting_frequency'] = params.get('reporting_frequency')
    return output

def create_output_meter_measure(params):
    output = dict()
    output.update({'measure_dir_name': 'AddOutputMeter'})
    output['arguments']={}
    output['arguments']['meter_name'] = params.get('variable_name')
    output['arguments']['reporting_frequency'] = params.get('reporting_frequency')
    return output